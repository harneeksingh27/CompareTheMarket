$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/Features/YourDetails.feature");
formatter.feature({
  "comments": [
    {
      "line": 1,
...
formatter.uri("src/Features/ourSupplier.feature");
formatter.feature({
  "comments": [
    {
      "line": 1,
...
formatter.uri("src/Features/yourEnergy.feature");
formatter.feature({
  "comments": [
    {
      "line": 1,
